          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                type="button"
                disabled={loading}
                className="px-3 py-2 bg-neutral-800/50 hover:bg-neutral-800 rounded-lg transition-all duration-200 group disabled:opacity-50 disabled:cursor-not-allowed"
              >
